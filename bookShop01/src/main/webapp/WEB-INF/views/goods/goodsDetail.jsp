			...
			<div class="tab_content" id="tab6">
				...
				<table border=1  >
				  ...
				  <c:forEach var="review" items="${goodsMap.reviewList }">
				    <tr>
				      ...
				      <td><a href="javascript:fn_reviewDetail('open','${review.review_content }');"> 
				                ${review.review_title }
				          </a>
				        </td>
                ...
                <table  style="visibility:hidden"  id="tbl_review">
                  ...
                  <tr  align="center">
                    <td> </td>  
                     <td>
                         <input type="button" value="등록하기"  onClick="fn_regReview()" />
...
<div id="layer_review" style="visibility: hidden">
		...
		<div id="popup">
			<!-- 팝업창 닫기 버튼 -->
			<a href="javascript:" onClick="javascript:fn_reviewDetail('close', '.layer_review');"> 
